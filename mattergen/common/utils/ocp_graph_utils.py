...
def get_max_neighbors_mask(
    ...
    num_neighbors = segment_coo(ones.to(pyg_device), index.to(pyg_device), dim_size=num_atoms).to(device_before)
    ...
    num_neighbors_image = segment_csr(num_neighbors_thresholded.to(pyg_device), image_indptr.to(pyg_device)).to(device_before)
